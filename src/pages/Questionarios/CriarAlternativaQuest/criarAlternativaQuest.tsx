import { useIonViewWillEnter, useIonViewWillLeave, IonPage, IonHeader, IonToolbar, IonRow, IonLabel, IonFabButton, IonIcon, IonButton, IonMenuButton, IonContent, IonItem, IonInput, IonCard, IonCardHeader, IonPopover, IonGrid, IonCol, IonCardContent, IonTextarea, IonModal, IonCardTitle, IonText, IonCardSubtitle, IonToggle } from '@ionic/react';
import { arrowUndoSharp, add, remove, timerOutline } from 'ionicons/icons';
...
import { NewAlternative, Payload, createFlashCard, Alternative } from '../../../services/flashCard.service';
